...
function attendanceLockingJob() {
  // DISABLED: Time restriction functionality has been removed
  // Teachers and HODs can now edit attendance at any time
  ...
  logger.info(
    "Attendance locking cron job disabled (time restrictions removed)"
  );
}
